...
function create-secrets(){
    ...
    kubectl create secret generic minio-key-oda-experiments --from-file=./private/minio-key.txt
    
    kubectl delete secret jena-password || echo "no secret yet, will create"
